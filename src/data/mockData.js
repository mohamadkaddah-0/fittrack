...
export const EXERCISES = [
  ...
  },
  {
    ...
    videoId: "ZZZoCNMU48U",
    equipmentName: "None", type: "Cardio drill",
    primaryMuscles: ["Hip Flexors", "Quads", "Core"],
    secondaryMuscles: ["Calves", "Glutes"],
    steps: ["Stand tall with feet hip-width apart.", "Drive one knee up toward your chest.", "Switch sides quickly.", "Pump your arms naturally."],
  ...
  },
  {
    ...
    videoId: "dZgVxmf6jkA",
    equipmentName: "None", type: "HIIT",
    primaryMuscles: ["Chest", "Legs", "Core"],
    secondaryMuscles: ["Shoulders", "Triceps"],
    steps: ["Squat down and place hands on the floor.", "Kick your feet back into a plank.", "Jump feet back toward your hands.", "Explode upward into a jump."],
  ...
  },
  {
    ...
    videoId: "nmwgirgXLYM",
    equipmentName: "None", type: "Cardio + core",
    primaryMuscles: ["Core", "Shoulders"],
    secondaryMuscles: ["Hip Flexors", "Chest"],
    steps: ["Start in a strong plank position.", "Drive one knee toward your chest.", "Switch legs quickly.", "Keep your hips low and stable."],
  ...
  },
  {
    ...
    videoId: "iSSAk4XCsRA",
    equipmentName: "None", type: "Warm-up cardio",
    primaryMuscles: ["Shoulders", "Quads", "Calves"],
    secondaryMuscles: ["Core"],
    steps: ["Stand upright with feet together.", "Jump feet apart while lifting arms overhead.", "Return to the start position.", "Repeat in a steady rhythm."],
  ...
  },
  {
    ...
    videoId: "wnJDq0dFJZU",
    equipmentName: "None", type: "Cardio",
    primaryMuscles: ["Quads", "Calves", "Core"],
    secondaryMuscles: ["Hip Flexors"],
    steps: ["Stand tall.", "Begin jogging in place.", "Use your arms naturally.", "Keep a steady rhythm."],
  ...
  },
  {
    ...
    videoId: "LE4JHT3JTGE",
    equipmentName: "Bike", type: "Endurance cardio",
    primaryMuscles: ["Quads", "Glutes"],
    secondaryMuscles: ["Hamstrings", "Calves"],
    steps: ["Adjust the bike properly.", "Start pedaling at a steady pace.", "Keep your shoulders relaxed.", "Maintain smooth pedal strokes."],
  ...
  },
  {
    ...
    videoId: "iRQpYC9JXMU",
    equipmentName: "Treadmill", type: "Low-impact cardio",
    primaryMuscles: ["Quads", "Calves"],
    secondaryMuscles: ["Core", "Glutes"],
    steps: ["Start at a comfortable speed.", "Walk tall with chest up.", "Swing your arms naturally.", "Increase incline if needed."],
  ...
  },
  {
    ...
    videoId: "H0r_D6_S9lg",
    equipmentName: "Rowing machine", type: "Full-body cardio",
    primaryMuscles: ["Back", "Legs"],
    secondaryMuscles: ["Biceps", "Core"],
    steps: ["Push first with your legs.", "Lean back slightly.", "Pull the handle to your lower ribs.", "Return smoothly in reverse order."],
  ...
  },
  {
    ...
    videoId: "p7p89P7bJa8",
    equipmentName: "Stair climber machine", type: "Cardio",
    primaryMuscles: ["Glutes", "Quads"],
    secondaryMuscles: ["Calves", "Hamstrings"],
    steps: ["Step naturally with full foot contact.", "Keep your chest up.", "Use a controlled pace.", "Avoid leaning heavily on the handles."],
  ...
  },
  {
    ...
    videoId: "IODxDxX7oi4",
    equipmentName: "None", type: "Bodyweight strength",
    primaryMuscles: ["Chest", "Triceps"],
    secondaryMuscles: ["Shoulders", "Core"],
    steps: ["Start in a plank position.", "Lower your chest under control.", "Keep elbows slightly angled.", "Press back up strongly."],
  ...
  },
  {
    ...
    videoId: "vcBig73ojpE",
    equipmentName: "Bench + barbell", type: "Compound strength",
    primaryMuscles: ["Chest"],
    secondaryMuscles: ["Triceps", "Front Delts"],
    steps: ["Set your grip on the bar.", "Unrack the bar with control.", "Lower to the middle of your chest.", "Press back up smoothly."],
  ...
  },
  {
    ...
    videoId: "eGo4IYlbE5g",
    equipmentName: "Pull-up bar", type: "Bodyweight strength",
    primaryMuscles: ["Lats", "Biceps"],
    secondaryMuscles: ["Forearms", "Upper Back"],
    steps: ["Hang from the bar with straight arms.", "Pull your chest upward.", "Drive elbows down and back.", "Lower slowly under control."],
  ...
  },
  {
    ...
    videoId: "CAwf7n6Luuc",
    equipmentName: "Cable machine", type: "Machine strength",
    primaryMuscles: ["Lats"],
    secondaryMuscles: ["Biceps", "Upper Back"],
    steps: ["Grip the bar comfortably.", "Pull it toward your upper chest.", "Drive elbows down.", "Return slowly to the top."],
  ...
  },
  {
    ...
    videoId: "aclHkVaku9U",
    equipmentName: "None", type: "Compound strength",
    primaryMuscles: ["Quads", "Glutes"],
    secondaryMuscles: ["Hamstrings", "Core"],
    steps: ["Stand with feet about shoulder-width apart.", "Sit hips back and down.", "Keep your chest up.", "Drive through your heels to stand."],
  ...
  },
  {
    ...
    limitedFor: ["Knee issues", "Joint pain"],
    image: "https://images.unsplash.com/photo-1595078475328-1ab05d0a6a0e?w=600&q=80",
    videoId: "QOVaHwm-Q6U",
    equipmentName: "None", type: "Bodyweight strength",
    primaryMuscles: ["Quads", "Glutes"],
    secondaryMuscles: ["Hamstrings", "Core"],
    steps: ["Step forward with one leg.", "Lower both knees under control.", "Keep torso upright.", "Push back to the start."],
  ...
  },
  {
    ...
    videoId: "op9kVnSso6Q",
    equipmentName: "Barbell", type: "Compound strength",
    primaryMuscles: ["Hamstrings", "Glutes"],
    secondaryMuscles: ["Back", "Core", "Forearms"],
    steps: ["Set feet under the bar.", "Hinge and grip the bar.", "Brace and push through the floor.", "Stand tall, then lower with control."],
  ...
  },
  {
    ...
    videoId: "IZxyjW7MPJQ",
    equipmentName: "Leg press machine", type: "Machine strength",
    primaryMuscles: ["Quads", "Glutes"],
    secondaryMuscles: ["Hamstrings"],
    steps: ["Place feet on the platform.", "Lower the weight under control.", "Keep knees aligned.", "Press back up smoothly."],
  ...
  },
  {
    ...
    videoId: "qEwKCR5JCog",
    equipmentName: "Dumbbells or barbell", type: "Compound strength",
    primaryMuscles: ["Shoulders"],
    secondaryMuscles: ["Triceps", "Upper Chest"],
    steps: ["Bring weights to shoulder height.", "Brace your core.", "Press overhead.", "Lower with control."],
  ...
  },
  {
    ...
    image: "https://images.unsplash.com/photo-1581009146145-b5ef050c2e1e?w=600&q=80",
    videoId: "ykJmrZ5v0Oo",
    equipmentName: "Dumbbells or barbell", type: "Isolation",
    primaryMuscles: ["Biceps"],
    secondaryMuscles: ["Forearms"],
    steps: ["Stand tall with weights at your sides.", "Keep elbows tucked near your body.", "Curl the weight upward.", "Lower slowly under control."],
